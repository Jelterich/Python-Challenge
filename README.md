...
PyPoll
Overview
PyPoll is a Python script designed to analyze election data and determine the election results. The script reads data from a CSV file, performs calculations, and outputs the results to the terminal and a text file.
...
An analysis folder that contains your text file with the results from your analysis.
...
Results Printed out correctly to terminal (40 points)
...
Place your election data CSV file in the Resources folder.
Run the script:
bash
...
Usage
Ensure you have Python installed on your system.
Place your financial data CSV file in the Resources folder.
Run the script:
bash
The results
